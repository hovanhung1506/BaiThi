...
/**
 * Servlet implementation class capnhatthongtindt
 */
@WebServlet("/capnhatthongtindt")
public class capnhatthongtindt extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			if (anh == null) {
				dtbo.SuaDienThoaiBO(madt, tendt, gia, mansx, soluong);
				tsktbo.SuaTSKTBO(madt, kichthuocmanhinh, congnghemanhinh, camerasau, cameratruoc, chipset, ram, rom,
						pin, thesim, hedieuhanh, dophangiaimanhinh, loaicpu, kichthuoc);
			}
			if(anh != null) {
				String anhcu = dtbo.XoaAnhBO(madt);
				String dirURL1 = request.getServletContext().getRealPath("");
				File f = new File(dirURL1 + "\\" + anhcu);
				f.delete();
				dtbo.SuaDienThoaiFullBO(madt, tendt, gia, mansx, anh, soluong);
				tsktbo.SuaTSKTBO(madt, kichthuocmanhinh, congnghemanhinh, camerasau, cameratruoc, chipset, ram, rom,
						pin, thesim, hedieuhanh, dophangiaimanhinh, loaicpu, kichthuoc);
			}
